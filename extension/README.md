...
6. `Create Flashcards with OpenClaw` sends study cards to Telegram and stores them in server-side `FLASHCARDS.md` (recommended path: `~/.openclaw/workspace/FLASHCARDS.md`).
